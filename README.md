...
| `make_tiles`        | Make an image zoomable with Leaflet.js. This program generates map tiles (256x256 pixels images) in a direcotory with the following structure: {zoom level}/{x}_{y}.png. The minimum zoom level is 0. This corresponds to a 256x256 square image and can be represented by single tile image (0/0_0.png). With each zoom level the square size is multiplied by 2. The default maximum zoom level is 2. This corresponds to a 1024x1024 square image and can be represented by 16 tile images (2/0_0.png, 2/1_0.png, 2/2_0.png, ... 2/3_3.png). | [rails project -- medusa](https://github.com/misasa/medusa)                                                                                                                                                                                                                                                                                 |
