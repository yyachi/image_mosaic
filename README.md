...
| `make_tiles`        | Make an image zoomable with Leaflet.js. This program generates map tiles (256x256 pixels images) in a directory with the following structure: {zoom level}/{x}_{y}.png. For zoom level 2, the program transforms the source image to fit with the 1024x1024 square image and split it into 16 tile images (2/0_0.png, 2/1_0.png, 2/2_0.png, ... 2/3_3.png). The maximum zoom level can be specified by arguments.| [rails project -- medusa](https://github.com/misasa/medusa)                                                                                                                                                                                                                                                                                 |
