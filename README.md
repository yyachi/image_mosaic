...
| `make_tiles`        | Project an image into VS space and make the VS space zoomable with Leaflet.js. This program generates map tiles (256x256 pixels images) in a directory with the following structure: {zoom level}/{x}_{y}.png. For example at zoom level 2, the program projects the source image into the the VS space (1024x1024 square image) and split the VS space into 16 map tiles (2/0_0.png, 2/1_0.png, 2/2_0.png, ... 2/3_3.png). The length and center of the VS space, position of the source image, and the maximum zoom level can be specified by arguments.| [rails project -- medusa](https://github.com/misasa/medusa)                                                                                                                                                                                                                                                                                 |
