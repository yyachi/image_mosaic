...
| `image-warp`                   | Project image into VS space based on Affine matrix `affine_xy2vs` stored in imageometry file and export sub-area of the VS space as image file.                                                             | Incompatible with OpenCV3. Supports `affine_ij2vs'. Interactive-command. |
