...
| image-warp-clicks   | Transform imagefile by matching three coordinates. Accepts anchors_ij via GUI and anchors via stdin.  Supports affine_ij2xy.                                      | Not compatible with OpenCV3. interactive-command. image-get-affine + transform     |
