...
| `transform_image` (obsolete)  | This command is subset of `warp_image`, but the sub-area of exporting is always same as that of the source image.                                                                  | Compatible with OpenCV3. Supports `affine_ij2ij`.                                                                                                                                                                                                                                                                                                                                                    |
