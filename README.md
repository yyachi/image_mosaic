...
| image_in_image      | Put an image file in a wallpaper image with an affine transformation.|Compatible with OpenCV3. Used in [rails project -- medusa](https://github.com/misasa/medusa).|
