...
| `make_tiles`        | Split an image and create map tiles (256x256 pix images) to use with Leaflet.js. This program generate a direcotory with the following structure: {zoom level}/{x}_{y}.png | [rails project -- medusa](https://github.com/misasa/medusa)                                                                                                                                                                                                                                                                                 |
