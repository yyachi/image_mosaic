...
| `transform_image` (obsolete)  | This command is subset of `warp_image`.  The area to be exported is same as that of the source image.                                                                  | Compatible with OpenCV3. Supports `affine_ij2ij`.                                                                                                                                                                                                                                                                                                                                                    |
